...
une_paire(main(carte(H,_),carte(H,_),carte(H2,_),carte(H2,_),_)).
une_paire(main(carte(H,_),carte(H,_),_,carte(H2,_),carte(H2,_))).
une_paire(main(_,carte(H,_),carte(H,_),carte(H2,_),carte(H2,_))).
...
full(main(carte(H1,_),carte(H1,_),carte(H2,_),carte(_,_),carte(H2,_)):-
					\==(H1,H2).
full(main(carte(H1,_),carte(_,_),carte(H1,_),carte(H2,_),carte(H2,_)):-
					\==(H1,H2).
